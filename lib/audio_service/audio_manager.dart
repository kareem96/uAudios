...
import 'package:appaudios/audio_service/notifiers/progress_notifier.dart';
import 'package:appaudios/audio_service/notifiers/repeat_button_notifer.dart';
...
import 'notifiers/media_type_notifier.dart';
...
class AudioManager {
  ...
  final loadingNotifier = LoadingNotifer();
  ...
  Future<void> addQueueItem(MediaItem mediaItem) => _audioHandler.addQueueItem(mediaItem);
